...
expected = {"services/agent-service/src/agent_core/lifecycle/goal_granularity.py"}
...
report = {
    "status": "WP08_NEW_RELEASE_ATTEMPT1_BLIND_GRANULARITY_BASELINE_GENERATED",
...
(root / "wp08-attempt1-blind-granularity-baseline-report.json").write_text(
