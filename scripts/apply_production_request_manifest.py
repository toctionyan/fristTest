...
REQUIRED_FILES = {
    ...
    "scripts/locked_python.py",
    "scripts/quality_loop.py",
    "scripts/run_production_release.py",
    "services/agent-service/tests/runtime/test_release_owned_runtime_boundary.py",
...
def main() -> None:
    ...
    if missing:
        raise RuntimeError(f"manifest omitted protected request/runtime files: {missing}")
