...
description: Use before any product-code diagnosis, design, repair, migration, revert, or certification；显式 `/diagnose` 或 `/repair` 时必须使用。Enforces the portable skillctl Change Contract and shared product Quality Loop.
---
