...
report = {
    "status": "WP08_POST_ATTEMPT8_DEPENDENCY_BASELINE_GENERATED",
...
(root / "wp08-post-attempt8-dependency-baseline-report.json").write_text(json.dumps(report, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
