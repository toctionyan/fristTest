...
expected = {
    "services/agent-service/src/agent_modules/ecommerce/capabilities/get_order_details.py",
    "services/agent-service/src/agent_modules/ecommerce/capabilities/list_orders.py",
}
...
report = {
    "status": "WP08_NEW_RELEASE_ATTEMPT5_BASELINE_GENERATED",
...
(root / "wp08-attempt5-baseline-report.json").write_text(json.dumps(report, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
