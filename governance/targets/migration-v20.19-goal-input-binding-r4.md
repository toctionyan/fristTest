...
- 目标 ID：migration-v20.19-goal-input-binding-r4
- 变更标识：portable-migration-v20.19-goal-input-binding-r4
- 执行上下文：local-change
- 目标类型：migration
...
- 最低质量模式：quick
- 声明清单：`governance/claims/migration-v20.19-goal-input-binding-r4.json`
- 验收 ID：`V2019.GOAL_INPUT_BINDING_SINGLE_AUTHORITY_R4`
...
Baseline: exact origin/main aeb11e0a plus the separately validated Quality Controller repair, validated repair-round bookkeeping controller repair, and immutable test-only RED oracle overlay, before any Goal Input Binding product implementation.
