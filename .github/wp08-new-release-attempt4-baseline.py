...
expected = {"services/agent-service/scripts/verify_preprod_conversation_smoke.py"}
...
report = {
    "status": "WP08_NEW_RELEASE_ATTEMPT4_BASELINE_GENERATED",
...
(root / "wp08-attempt4-baseline-report.json").write_text(json.dumps(report, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
