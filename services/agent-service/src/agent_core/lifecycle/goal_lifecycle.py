    ...
    *,
    ...
    for goal in list(contract.get("goals") or []):
        ...
        existing.update({
            ...
            "reference_expression": deepcopy(goal.get("reference_expression")) if goal.get("reference_expression") is not None else existing.get("reference_expression"),
            "referent_resolution_proof": deepcopy(goal.get("referent_resolution_proof")) if goal.get("referent_resolution_proof") is not None else existing.get("referent_resolution_proof"),
            "resolved_reference": deepcopy(goal.get("resolved_reference")) if goal.get("resolved_reference") is not None else existing.get("resolved_reference"),
