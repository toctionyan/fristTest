...
OUTPUT = ROOT / ".github/diagnostics/production-004-runs.json"
...
headers = {
    ...
    "User-Agent": "production-004-status-inspector",
}
    ...
    for run in payload.get("workflow_runs") or []:
        if str(run.get("head_sha") or "") == TARGET_SHA:
            return {
                ...
                "artifacts_url": str(run.get("artifacts_url") or ""),
            }
    return None
...
result: dict[str, object] = {
    ...
    "request_id": "production-certification-20260801-004",
