...
def validate_static(workspace_root: Path) -> dict[str, Any]:
    ...
    if not workflow_path.is_file() or not runner_path.is_file() or not resume_path.is_file():
        raise WP08ContractError("wp08_asset_missing", "WP-08 workflow, runner or resume validator is missing")
