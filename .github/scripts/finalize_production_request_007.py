...
TRANSIENT_FILES = {
    ".github/diagnostics/production-request-007-trigger.txt",
    ".github/scripts/finalize_production_request_007.py",
    ".github/workflows/one-time-finalize-production-request-007.yml",
}
REQUIRED_FILES = {
