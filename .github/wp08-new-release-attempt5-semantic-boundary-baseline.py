...
report = {
    "status": "ATTEMPT5_SEMANTIC_BOUNDARY_BASELINE_GENERATED",
...
(root / "wp08-attempt5-semantic-boundary-baseline-report.json").write_text(json.dumps(report, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
